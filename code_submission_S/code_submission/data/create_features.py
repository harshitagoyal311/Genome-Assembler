...
if __name__ == '__main__':
	...
	for seq_record in SeqIO.parse(sys.argv[1],"fasta"):
		contigs.append( str(seq_record))
		contig_list.append((counter+1, str(seq_record)))
		if counter < 4:
			print (counter+1)
			print len(str(seq_record))
		counter +=1
	print "-------------------------"
